      ...
      {isWinner && (
        <div className="absolute inset-0 z-50 flex items-center justify-center p-4 animate-pop-in">
          <div className="bg-[#1a1a1a]/90 backdrop-blur-md border-4 border-white/10 p-8 w-full max-w-sm relative text-center rounded-[30px] shadow-2xl flex flex-col items-center">
            ...
            <h2 className="font-sketch text-4xl mb-6 text-white tracking-widest uppercase drop-shadow-md">
              {gameState.winner === 'Draw' ? 'Draw!' : `${gameState.winner === 'A' ? 'You Win!' : 'You Lose!'}`}
            </h2>
